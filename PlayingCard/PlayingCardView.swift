...
//  PlayingCard
//
//  Created by Michel Bernardo on 24/03/21.
//
...
class PlayingCardView: UIView {
  ...
  // Used to draw the pips in the correct position: (Positioning error here)
  private func drawPips() {
    ...
    if pipsPerRowForRank.indices.contains(rank) {
      ...
      pipRect.origin.y += (pipRowSpacing - pipRect.size.height
      ) / 2
